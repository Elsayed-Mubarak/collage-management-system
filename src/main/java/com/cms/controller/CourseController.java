...
public class CourseController {
	...
	public String addcourse(HttpServletRequest request , HttpSession session) {
		String d = (String) session.getAttribute("userType") ; 
	...
	public String saveCourseIndataBase(@ModelAttribute Course course, BindingResult binding,
	...
	public String showAllCoursesToUsers(@PathVariable("year") String year, HttpServletRequest request , HttpSession session) {
		request.setAttribute("courses", courseServcie.getAllCoursesByYear(year));
		request.setAttribute("mode", "ALL_COURSES_TO_USERS");
