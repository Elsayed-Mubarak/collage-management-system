...
<head>
<title>Tanta University LOGIN Form</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="login Form for tanta university student" />
<script>
	...
	<div id="home" class="home">
		...
		<div class="login-form">
			...
			<div class="header-w3l">
				<h1>
					<span>T</span>anta <span>U</span>university <span>L</span>ogin <span>F</span>orm
				</h1>
			</div>
			<!--//header-->
			<!---728x90--->
