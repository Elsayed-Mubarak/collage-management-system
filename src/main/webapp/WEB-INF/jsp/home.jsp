            ...
            <div class="container">
             ...
             <form>
                 <a href="home.html"><h1><span>T</span>anta University <i class="fa fa-graduation-cap" aria-hidden="true"></i></h1></a>
                   ...
                   <button class="signin"  type="submit"  formaction="/login">SIGN IN</button>
                   <button class="signup"  type="submit"  formaction="/registration">SIGN Up</button>
       ...
       -->
                        ...
                        <li>
                            <ul>
                                ...
                                <li class="Studends"><a href="#">�STUDENTS</a>
                                    <ul>
                                        <li><a href="http://localhost:8010/welcome" >Student Courses</a></li>
        ...
        <!--End of Bar --> 
         ...
         <!--start of body -->
          ...
          <div class="back">
                <div class="container">
                    <h2>college management <span>system</span></h2>
                </div>
            </div>
         <!--End of body -->
        ...
        <div id="about" class="about">
            ...
            <div class="about-left">
                <img src="static/images/10.jpg" alt="student pic" class="img-responsive">
            </div>
            ...
            <div class="object" id="obj">
                <div class="container">
                    <div class="main-obj">
                        ...
                        <p>THis is about learning objectives to reach the best accuracy of leaening</p>
                        <hr>
                    </div>
                                <div class="clearfix"></div>
            ...
            <div class="container">
                ...
                <div class="images">
                    <div class="img1">
                        ...
                        <h4>Tahani allam</h4>
                        <ul>
                            <li><a href="https://www.facebook.com/eng.tahaniallam"> <i class="fa fa-facebook"></i> </a></li>
                            <li><a href="https://www.Twiteer.com/ELKHOLE"><i class="fa fa-twitter"></i></a></li>
                        </ul>
                    </div>
                    <div class="img2">
                    ...
                    <div class="img3">
                        ...
                        <h4>Amani sarhan</h4>
                        <ul>
                            <li><a href="https://www.facebook.com/ELKHOLE"><i class="fa fa-facebook"></i></a></li>
                            <li><a href="https://www.Twiteer.com/ELKHOLE"><i class="fa fa-twitter"></i></a></li>
                        </ul>
                    </div>
                    <div class="img4">
    ...
    <!--start of news-->
        <div class="news" id="new">
            <div class="container">
                ...
                <div class="right-top">
                    <div class="button">
                        <a href="small-dialog" class="play" ><span class="play-circlre" aria-hidden="true" ></span></a>
                    </div>
                    <div id="small-dialog" class="a">
                        <div class="b">
                             <iframe src="https://www.youtube.com/watch?v=1Y62DfhOzsM" frameborder="0" allowfullscreen ></iframe>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="contact-info">
						...
						<div class="contact-info-right">
							<h5>Address:-</h5>
							<p>Sabarbay, Tanta, Gharbia Governorate, <br>EGYPT.
								</p>
                            <div class="clearfix"> </div>
				        </div>
                        <div class="contact-info">
    ...
    <!--End of training-->     
        ...
        <div class="header">
            <div class="container">
                ...
                <select>
                     <p>signed in as</p>
                    <option><button><img class="q" src="static/images/f3.jpg"></button></option>
                <option><button>Ahmd Elkholy</button></option>
                    <optgroup></optgroup>
                    <option><button>Your Profile</button></option>
                    <option><button >Your Stars</button></option>
                    <option><button>Your Gists</button></option>
                    <optgroup></optgroup>
                    <option><button>Setting</button></option>
                    <div >
                ...
                <div class="footer">
                    <div class="container">
                        ...
                        <div class="right">
                            <h3>Keep in touch wih us</h3>
                            <ul>
                                <li><a href="https://www.facebook.com/ELKHOLE"><i class="fa fa-facebook"></i></a> <a class="ahmd" href="https://www.facebook.com/ELKHOLE">Facebook</a></li>
                               
                                <li><a href="https://twitter.com/AhmdElkhole"><i class="fa fa-twitter"></i></a><a href="https://twitter.com/AhmdElkhole">Twitter</a></li>
