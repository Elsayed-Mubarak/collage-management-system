...
<html>
    <head>
        ...
        <link rel="stylesheet" href="static/css/fonttest.css" type="text/css">
        <link rel="stylesheet" href="static/css/normal.css" type="text/css">
        <link rel="stylesheet" href="static/css/normalization.css" type="text/css">
        <link rel="stylesheet" href="static/css/profile.css" type="text/css">
        <link rel="stylesheet" href="static/css/research.css" type="text/css">
        <link rel="stylesheet" href="static/css/research2.css" type="text/css">
        <link rel="stylesheet" href="static/css/training.css" type="text/css">
        ...
        <div class="header" >
            <div class="container">
                <a href="/home"><img src="static/images/logo.png" ></a>
                 <a href="/home"><h1><span>T</span>anta University <i class="fa fa-graduation-cap" aria-hidden="true"></i></h1></a>
                <div class="sign">
                   <a class="signin" href="/login" id="signin">SIGN IN</a>
                    <a class="signup"  href="/registeration" id="signup">SIGN Up</a>
                    </div>
                    </div>        
            </div> 
        <!--End of Header --> 
            ...
            <div class="container">
               <nav>
                    <ul class="nav-bar" class="hvr-rectangle-out-scroll">
                        <li>
                            <ul>
                                <li class="active"><a href="/home" class="hoome" class="hvr-rectangle-out-scroll">HOME</a></li>
                                ...
                                <li><a href="#" class="hvr-rectangle-out-scroll">RESEARCH</a>
                                     ...
                                     <ul>
                                        <li><a href="#banner" class="hvr-rectangle-out-scroll">Center and Facilities</a></li>
                                         ...
                                         <li><a id="pub" href="/research" class="hvr-rectangle-out-scroll" >Research and publications</a></li>
                                        <li><a href="#obj" class="hvr-rectangle-out-scroll"> Learning Objective</a></li>
                                        <li><a href="/focus" class="hvr-rectangle-out-scroll">Research Focus</a></li>
                                    </ul>
                                </li>
                                <li><a href="#" class="hvr-rectangle-out-scroll">FACULTIES</a>
                                    <ul>
                                        ...
                                        <li><a  id="train" href="/training" class="hvr-rectangle-out-scroll"> activities</a></li>
                                    </ul>
                                </li>
                                <li><a href="#" class="hvr-rectangle-out-scroll">DEPARTMENT</a>
                                    <ul>
                                        ...
                                        <li><a href="#" class="hvr-rectangle-out-scroll">Electrical</a>
                                            <ul>
                                                ...
                                                <li><a href="#" class="hvr-rectangle-out-scroll">Computers &amp;Control</a>
                                                    <ul>
                                                        <li><a href="show-courses-to-users" class="hvr-rectangle-out-scroll">All Courses</a></li>
                                                        <li><a href="show-courses-to-user/2nd%20year" class="hvr-rectangle-out-scroll">Second Year</a></li>
                                                        <li><a href="show-courses-to-user/3rd%20year" class="hvr-rectangle-out-scroll">Third Year</a></li>
                                                        <li><a href="show-courses-to-user/4th%20year" class="hvr-rectangle-out-scroll">Forth Year</a></li>
                                                    </ul>
                                                </li>
                                        ...
                                        <li><a href="/show-schedule" class="hvr-rectangle-out-scroll"> Time Table</a></li>
                                    </ul>
                                </li>
                                <li><a href="#" class="hvr-rectangle-out-scroll">OUR-FACULTY</a>
                                <ul>
                                        <li><a href="#about" class="hvr-rectangle-out-scroll">History &amp; About</a></li>
                                        <li><a href="/offices" class="hvr-rectangle-out-scroll"> Offices</a></li>
                                        <li><a href="/vision" class="hvr-rectangle-out-scroll">Faculty Vision</a></li>
                                    </ul>
                                </li>
    ...
    <!--start of faculties-->
        <div class="fac" id="fac">
            <div class="container">
                ...
                <div class="images">
                    <div class="img1">
                        <img src="static/images/1.jpg" alt="dr.tahani">
                       <a href="/AllInstructors/1" ><h4>Tahani allam</h4></a>
                       
                        <ul>
                            <li class="facebo"><a href="https://www.facebook.com/eng.tahaniallam"> <i class="fa fa-facebook"></i> </a></li>
                            <li class="facebo"><a href="#"><i class="fa fa-twitter"></i></a></li>
                        </ul>
                    </div>
                    <div class="img2">
                         <img src="static/images/2.jpg" alt="dr.sherin">
                           <a href="/AllInstructors/9"><h4>Sherin elgokhy</h4></a> 

                        <ul>
                            <li class="facebo"><a href="https://www.facebook.com/eng.sheringokhy">  <i class="fa fa-facebook"></i> </a></li>
                            <li class="facebo"><a href="#"      >                                    <i class="fa fa-twitter"></i> </a></li>
                        </ul>
                        
                    </div>
                    <div class="img3">
                        <img src="static/images/3.jpg" alt="dr.sherin">
                          <a href="/AllInstructors/2"><h4>Amani sarhan</h4></a> 
                       
                        <ul>
                            <li class="facebo"><a href="https://www.facebook.com/profile.php?id=100011129884166"><i class="fa fa-facebook"></i></a></li>
                            <li class="facebo"><a href="#" <i class="fa fa-twitter"></i></a></li>
                        </ul>
                    </div>
                    <div class="img4">
